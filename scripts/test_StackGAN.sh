...
LOG="/home/dhkim/checkpoints/${experiment_dir}/test.txt"
if [ -f $LOG ]; then
	rm $LOG
fi
...
# =======================================
model_1_pretrained="/home/dhkim/checkpoints/GlyphNet_pretrain/upper"
if [ ! -f "/home/dhkim/checkpoints/${experiment_dir}/600_net_G.pth" ]; then
    cp "${model_1_pretrained}/600_net_G.pth" "/home/dhkim/checkpoints/${experiment_dir}/"
    cp "${model_1_pretrained}/600_net_G_3d.pth" "/home/dhkim/checkpoints/${experiment_dir}/"
fi
...
# =======================================
CUDA_VISIBLE_DEVICES=${CUDA_ID} python /home/dhkim/mc-gan-master/test_Stack.py --dataroot ${DATASET} --name "${experiment_dir}" --model ${MODEL}\
