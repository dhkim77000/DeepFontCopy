...
#=====================================
DATA=$1
DATASET="/home/dhkim/mc-gan-master/datasets/public_web_fonts/${DATA}/"
base_dir="/home/dhkim/mc-gan-master/datasets/Capitals64/BASE"
...
if [ ! -d "/home/dhkim/checkpoints/${experiment_dir}" ]; then
	mkdir "/home/dhkim/checkpoints/${experiment_dir}"
fi
...
model_1_pretrained="/home/dhkim/checkpoints/GlyphNet_pretrain" 
if [ ! -f "/home/dhkim/checkpoints/${experiment_dir}/400_net_G.pth" ]; then
    cp "${model_1_pretrained}/400_net_G.pth" "/home/dhkim/checkpoints/${experiment_dir}/"
    cp "${model_1_pretrained}/400_net_G_3d.pth" "/home/dhkim/checkpoints/${experiment_dir}/"
fi
...
for i in $all_epochs;
	...
	do CUDA_VISIBLE_DEVICES=${CUDA_ID} python /home/dhkim/mc-gan-master/test_Stack.py --dataroot ${DATASET} --name "${experiment_dir}" --model ${MODEL}\
...
CUDA_VISIBLE_DEVICES=${CUDA_ID} python /home/dhkim/mc-gan-master/test_video.py --dataroot ${DATASET} --name "${experiment_dir}" --model ${MODEL} \
								--which_model_netG ${MODEL_G} --which_model_netD ${MODEL_D} --n_layers_D ${n_layers_D} --norm ${NORM}\
