...
LOG="/home/dhkim/checkpoints/${experiment_dir}/output.txt"
if [ -f $LOG ]; then
    rm $LOG
fi
...
CUDA_VISIBLE_DEVICES=${CUDA_ID} python /home/dhkim/mc-gan-master/train_Stack.py --dataroot ${DATASET}  --name ${NAME} --model ${MODEL}\
