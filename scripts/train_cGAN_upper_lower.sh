...
experiment_dir="GlyphNet_pretrain/upper_lower"
MODEL=cGAN
...
# =======================================
CUDA_VISIBLE_DEVICES=${CUDA_ID} python /home/dhkim/mc-gan-master/train.py --dataroot ${DATASET} --name "${experiment_dir}" \
